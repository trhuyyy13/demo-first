						...
						<!-- /Billing Details -->
								...
								<form id="signup_form" onsubmit="return false" class="login100-form">
                                    ...
                                    <div class="section-title">
                                        <h2 class="login100-form-title p-b-49" >Đăng kí nè ^^</h2>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <input class="input form-control input-borders" type="text" name="address2" id="address2" placeholder="Tỉnh/Thành phố">
                                    </div>
                                    
                                    
                                    <div style="form-group">
                                       <input class="primary-btn btn-block"  value="Xác nhận đăng kí" type="submit" name="signup_button">
                                    </div>
                                    <div class="text-pad">
                                    <a href="" data-toggle="modal" data-target="#Modal_login">Bạn đã có tài khoản? Login đi</a>
